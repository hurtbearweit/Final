...
FUNCTION:老人票的查询
*****************/
void  ticket_old(int *page,int num)
{   int a=num;
    int tag;
    int pos3;
    int pos4;
	...
	puthz(35,140,"年龄要求为",24,24,RED);
	outtextxy(160,140,"60~69");
	puthz(220,140,"岁",24,24,RED);
	outtextxy(245,140,",");
	puthz(255,140,"按生日计算年龄",24,24,RED);
	...
	while(1)
	{
	   ...
	   if(MouseX>250&&MouseX<350&&MouseY>350&&MouseY<380)
		{           
			...
			{
				MouseS=0;
	            logging_data4(num1,b[0],a);
				logging_data4(num2,b[1],a);
				logging_data4(num3,b[2],a);
				logging_data4(num4,b[3],a);
				logging_data4(num5,b[4],a);
				draticket();
				clrmous(MouseX,MouseY);
				 delay(100);
				 save_bk_mou(MouseX, MouseY);
...
void logging_data4(char *p,DATE q,int a)
{   char d[20];
    int b=0;
	int l=0;
	int lu=0;
